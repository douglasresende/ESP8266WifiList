/*
  ESP8266WifiList.cpp - Library for show a great layout to witi list.
  Created by Douglas R Camargo, November 27, 2015.
  Released into the public domain.
*/

#include "arduino.h"
#include "ESP8266WifiList.h"

ESP8266WifiList::ESP8266WifiList()
{
}

String ESP8266WifiList::resetCss()
{
...
String ESP8266WifiList::baseCss()
{
  String css;
  css += "body {";
...
String ESP8266WifiList::tableCss()
{
  String css;
 css += "table {";
 css += "  color:#666;";
...
String ESP8266WifiList::modalCss()
{
  String css;
  css += ".modalDialog {";
  css += "  position: fixed;";
...
String ESP8266WifiList::buttonCss()
{
  String css;
  css += ".btn {";
  css += "  padding: 1px 5px;";
...
String ESP8266WifiList::inputCss()
{
  String css;
  css += ".form-control {";
  css += "  display: inline-block;";
...
String ESP8266WifiList::modalJs()
{
  String js;
...
String ESP8266WifiList::pageRootHtml()
{
  String html;
  ...
  html += "        <th>";
  html += "          Status";
  html += "          <button class='btn' onclick='connectWifi()'>Atualizar</button>";
  html += "          <button class='btn' onclick='lostWifi()'>Esquecer WiFi</button>";
  html += "        </th>";
  html += "        <th>Rede</th>";
  html += "        <th>IP</th>";
  html += "      </tr>";
  ...
  html += "      <tr>";
  html += "        <td colspan='3'>";
  html += "          <center>Desconectado</center>";
  html += "        </td>";
  html += "      </tr>";
  html += "    </tbody>";
  html += "  </table>";
  ...
  html += "        <th>";
  html += "          WiFi";
  html += "          <button class='btn' onclick='refreshWiFi()'>Atualizar</button>";
  html += "        </th>";
  html += "        <th>For&ccedil;a</th>";
  html += "        <th>Senha?</th>";
  html += "        <th>Conectar?</th>";
  html += "      </tr>";
  html += "    </thead>";
  ...
  html += "      <tr>";
  html += "        <td colspan='4'>";
  html += "          <center> Nenhuma rede WiFi encontrada</center>";
  html += "        </td>";
  html += "      </tr>";
  html += "    </tbody>";
  html += "  </table>";
  ...
  html += "          <td><input type='text' id='ssid' class='form-control' disabled='disabled' value='BIGGSONNO'/></td>";
  html += "        </tr>";
  html += "        <tr>";
  html += "          <td><strong>Senha:</strong></td>";
  html += "          <td><input type='password' id='pass' class='form-control'/></td>";
  html += "        </tr>";
  html += "        <tr class='even'>";
  html += "          <td colspan='2' class='center'>";
  html += "            <button class='btn' onclick='saveAndConnectWifi()'>Conectar</button>";
  html += "            <button class='btn' onclick='closeModal()'>Cancelar</button>";
  html += "          </td>";
  html += "        </tr>";
  html += "      </table>";
  html += "    </div>";
